...
function fslct($conn,$sql,$whr,$ord,$matchto,$id,$desc,$thisform) {
  echo "<select name=\"" . $id . "\" onchange='this.form.action=\"func.php\"; this.form.submit()'><option value=\"0\">";
...
<?php
echo fslct($conn,"select creditor_id crdd,creditor crd  from creditor"," where 1=1"," order by creditor limit 20",$_POST['crdd'],'crdd','crd','func.php');
?>
</td><td>branch</td><td>
<?php
if ($_POST['crdd']==null) {
